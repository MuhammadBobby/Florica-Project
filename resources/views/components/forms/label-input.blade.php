...
<div class="mb-5">
    ...
    <input type={{ $type }} id={{ $for }}
        class="border border-default-medium bg-white text-heading text-sm rounded-base focus:ring-primary focus:border-primary block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
