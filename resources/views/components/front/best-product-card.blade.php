...
<div class="block w-1/3 max-w-sm border-2 border-default rounded-base shadow-xs">
    <a href="#">
        <img class="rounded-t-base h-96 w-full object-cover"
    ...
    <div class="p-6 text-center">
        ...
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-primary">{{ $product->name }}</h5>
